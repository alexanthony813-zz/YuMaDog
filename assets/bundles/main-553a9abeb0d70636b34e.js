...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (props) {
	  return React.createElement(
	    ...
	    React.createElement('input', { className: 'form-control', value: 'Enter City and State as \'City, State\'', type: 'text', onblur: 'if (this.value == \'\') {this.value = \'email@abc.com\';}',
	      onfocus: 'if (this.value == \'Enter City and State as \'City, State\'\') {this.value = \'\';}', onChange: _.debounce(function () {
