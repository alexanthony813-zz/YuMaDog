	    ...
	    if (!this.props.item) {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement('img', { className: 'embed-responsive-item', src: this.props.item["profile_photo_url"] }),
	          React.createElement(
	            'p',
	            null,
	...
	module.exports = function (props) {
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement('img', { className: 'media-object', src: props.item["profile_photo_url"], alt: '' }),
	      '        ',
