...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(1).ID_ATTRIBUTE_NAME = 'data-myid';
	var React = __webpack_require__(4);
	var Nav = __webpack_require__(34);
	var SelectedDog = __webpack_require__(41);
	var DogList = __webpack_require__(40);
	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Nav, { searchHandler: this.handleSearch }),
	      React.createElement(
	        'div',
	        { className: 'col-md-7' },
	        React.createElement(SelectedDog, { item: this.state.currentVideo })
	      ),
	      React.createElement(
	        'div',
	        { className: 'col-md-5' },
	        React.createElement(DogList, { clickHandler: this.handleClick, item: this.state.videoList })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (props) {
	  return React.createElement(
	    ...
	    React.createElement('img', { id: 'loading', className: 'hidden', src: 'https://www.wpfaster.org/wp-content/uploads/2013/06/loading-gif.gif' })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (props) {
	  return React.createElement(
	    'div',
	    { className: 'search-bar form-inline', id: 'search' },
	    React.createElement('input', { className: 'form-control', id: 'form-control', type: 'text', placeholder: 'Enter \'City, State\'', onChange: _.debounce(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (props) {
	  ...
	  return React.createElement(
	    'div',
	    { className: 'dog-list-entry', onClick: function () {
	        props.clickHandler(props.item);
	      } },
	    React.createElement(
	      'div',
	      { className: 'media-left media-middle' },
	      React.createElement('img', { className: 'media-object', src: props.item["second_photo"], alt: '' })
	    ),
	    React.createElement(
	      'div',
	      ...
	      React.createElement(
	        'div',
	        { className: 'dog-list-entry-title' },
	        props.item["name"]
	      ),
	      React.createElement(
	        'div',
	        { className: 'dog-list-entry-detail' },
	        props.item["age"],
	        ' ',
	        props.item["sex"]
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(1).ID_ATTRIBUTE_NAME = 'data-myid';
	var React = __webpack_require__(4);
	var DogListEntry = __webpack_require__(39);
	    ...
	    return React.createElement(
	      ...
	      dogs.map(function (dog, i) {
	        return React.createElement(
	          'div',
	          { key: dog.name },
	          React.createElement(DogListEntry, { item: dog, clickHandler: props.clickHandler })
	        );
	      })
	    );
	  }
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    if (!this.props.item) {
	      ...
	      return React.createElement(
	        'div',
	        { className: 'selected-dog' },
	        React.createElement(
	          'div',
	          { className: 'selected-dog-details' },
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'div',
	                null,
	                this.props.item["contact_email"]
	              ),
	              React.createElement(
	                'div',
	                null,
	                this.props.item["contact_phone"]
	              )
	            )
	          ),
	          ...
	          React.createElement(
	            'div',
	            { className: 'img-block' },
	            React.createElement('img', { className: 'profile_photo', src: this.props.item["third_photo"] })
	          ),
	          React.createElement(
	            'div',
	            { className: 'description-container container-fluid' },
	            React.createElement(
	              'p',
	              null,
